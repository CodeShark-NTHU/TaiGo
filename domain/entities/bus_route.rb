...
module TaiGo
  module Entity
    ...
    class BusRoute < Dry::Struct
      attribute :route_uid, Types::Strict::String # maybe change to route_id?
      attribute :route_name, Types.Instance(TaiGo::MOTC::BusRouteMapper::DataMapper::Name) # maybe change to name?
